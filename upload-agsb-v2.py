...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "dim_stremlit"         # 用户名
UUID = "de98c6bf-afb9-49df-9aa1-598e42fc965a"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = ""                   # 域名，留空则自动获取
CF_TOKEN = "f57a95c219b081b21380aa50d39b80019a8ae"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
